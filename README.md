...
- [Rules of the game in the reST format](Rule_of_the_game.rst).<!-- Reusing off -->
...
- API reference based on a fictional OpenAPI: [AI generated](API_reference.adoc) (just for fun), [written manually](API_reference.md) (so far only one method).
