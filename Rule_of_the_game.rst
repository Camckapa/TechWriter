...
.. figure:: Images/Example_game_field.jpg
   :alt: Пример расположения кораблей
   :align: center
...
- · — если в клетке нет корабля. Ход переходит к противнику.

> Если корабль убит, для удобства можно обвести его по периметру и расставить вокруг него ·, чтобы обозначить клетки, в которых у противника точно не может быть кораблей, потому что корабли не могут касаться друг друга сторонами и углами.
